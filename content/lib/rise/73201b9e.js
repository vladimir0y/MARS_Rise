"use strict";(self.wpRiseJsonp=self.wpRiseJsonp||[]).push([["vendors-node_modules_pnpm_articulate_design-system_1_10_3__articulate_design-system-tokens_1_-5b5396"],{95577:(pc,ie,sa)=>{sa.r(ie),sa.d(ie,{Arc:()=>_i,ArcAbstractFlexLayouts:()=>Et,ArcAbstractGapSizes:()=>de,ArcAbstractIconSizes:()=>La,ArcAbstractPopoverActions:()=>la,ArcAbstractPopoverModes:()=>Pa,ArcAbstractTextLayouts:()=>_t,ArcAbstractTextOverflows:()=>pe,ArcAbstractTextSizes:()=>St,ArcAvatar:()=>Za,ArcAvatarColors:()=>Oe,ArcAvatarColorsReserved:()=>qt,ArcAvatarOverflow:()=>bn,ArcAvatarOverflowSizes:()=>ro,ArcAvatarPile:()=>uo,ArcAvatarPileSizes:()=>Qt,ArcAvatarSizes:()=>Wt,ArcAvatarText:()=>Xa,ArcAvatarTextGapSizes:()=>Kt,ArcAvatarTextOverflows:()=>Gt,ArcAvatarTextSizes:()=>Jt,ArcBadge:()=>kn,ArcBadgeContrasts:()=>wn,ArcBadgeCount:()=>En,ArcBadgeCountShapes:()=>_n,ArcBadgeCountSizes:()=>Cn,ArcBadgeCountVariants:()=>Sn,ArcBadgeLayouts:()=>yn,ArcBadgeSizes:()=>$n,ArcBadgeVariants:()=>An,ArcButton:()=>zr,ArcButtonDeprecatedVariants:()=>ut,ArcButtonHierarchies:()=>Yo,ArcButtonLayouts:()=>Fo,ArcButtonPopoverActions:()=>Zo,ArcButtonShapes:()=>Vo,ArcButtonSizes:()=>Do,ArcButtonVariants:()=>Uo,ArcCheckbox:()=>gt,ArcCheckboxBar:()=>Fn,ArcCheckboxBarLayouts:()=>Nn,ArcCheckboxBarOption:()=>Dn,ArcCheckboxBarSizes:()=>Vn,ArcCheckboxLayouts:()=>Mn,ArcCheckboxSizes:()=>On,ArcCheckboxVariants:()=>Bn,ArcDropdownMenu:()=>ee,ArcIcon:()=>I,ArcIconText:()=>cr,ArcIconTextVariants:()=>ko,ArcInputAction:()=>Qn,ArcLabel:()=>Cr,ArcLabelContent:()=>Sr,ArcLabelLayouts:()=>jn,ArcLink:()=>ei,ArcLinkVariants:()=>ai,ArcPopover:()=>oa,ArcPopoverActions:()=>vo,ArcPopoverAnchors:()=>We,ArcPopoverBoundaries:()=>Ke,ArcPopoverButton:()=>ea,ArcPopoverDefaults:()=>or,ArcPopoverModes:()=>qe,ArcPopoverVariants:()=>qa,ArcPopoverVariantsWithOutline:()=>mo,ArcRadio:()=>xt,ArcRadioBar:()=>di,ArcRadioBarLayouts:()=>ci,ArcRadioBarOption:()=>li,ArcRadioBarSizes:()=>si,ArcRadioLayouts:()=>oi,ArcRadioSizes:()=>ni,ArcSwitch:()=>vi,ArcSwitchLabelPositions:()=>Nr,ArcSwitchSizes:()=>pi,ArcSwitchStates:()=>V,ArcSystemAlignments:()=>se,ArcSystemColors:()=>Ia,ArcSystemHierarchies:()=>ce,ArcSystemLayouts:()=>sr,ArcSystemLineHeights:()=>le,ArcSystemShapes:()=>ja,ArcSystemSizes:()=>er,ArcSystemVariants:()=>q,ArcTextAlignments:()=>wi,ArcTextBodyElements:()=>yt,ArcTextBodySizes:()=>$i,ArcTextBodyVariants:()=>yi,ArcTextElements:()=>wt,ArcTextHeadingElements:()=>$t,ArcTextHeadingSizes:()=>fi,ArcTextHeadingVariants:()=>xi,ArcTextInput:()=>Ji,ArcTextInputLayouts:()=>qi,ArcTextInputSizes:()=>Wi,ArcTextInputTypes:()=>Gi,ArcTextInputVariants:()=>Ki,ArcTextKinds:()=>mi,ArcTextLineHeights:()=>Ai,ArcTextSubheadingSizes:()=>bi,ArcTextTitleSizes:()=>gi,ArcToast:()=>zt,ArcToastPlacements:()=>sc,ArcToastPopoverActions:()=>cc,ArcToastPopoverModes:()=>ic,ArcToastProgressBarVariants:()=>lc,ArcToastSeverities:()=>tc,ArcToastSizes:()=>oc,ArcToastVariants:()=>nc,ArcTooltip:()=>pt,ArcTooltipDefaults:()=>vr,LogoArticulate:()=>He,LogoProductAI:()=>Ne,LogoProductPeek:()=>Ve,LogoProductReach:()=>De,LogoProductReview:()=>Fe,LogoProductRise:()=>Ue,LogoProductStoryline:()=>Ye,adoptStyles:()=>S,assignRef:()=>ue,bindDelegatedEvents:()=>dt,clamp:()=>he,css:()=>u,didElementRectChange:()=>ve,extractTextFromReactNode:()=>Qr,getPopoverId:()=>ga,getPreferredAnchorForTooltipId:()=>re,isDifferent:()=>$r,isSame:()=>da,joinArray:()=>it,makeHtmlId:()=>dr,mapDeprecated:()=>Tt,pickFromList:()=>A,unbindDelegatedEvents:()=>Ho,updatePopoverPosition:()=>Wa});const ja=["circle","square","narrow"],q=["inherit","common","disabled","neutral","outline","solid","critical","ai","primary","secondary","tertiary","inverse","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse","overlay-light","overlay-dark","brand-black","brand-blue","brand","info","success","warning"],ce=["primary","secondary","tertiary","plain"],sr=["hug","fill","icon","gutter","inline"],se=["inherit","start","left","justify","center","between","around","evenly","stretch","end","right"],le=["inherit","tight","standard","loose"],er=["inherit","xxl","xl","lg","md","sm","xs","xxs"],Ia=["blue","orange","mint","red","yellow","green","maroon","purple","neutral","white","black"],Pa=["","auto","manual"],la=["toggle","show","hide"],La=["inherit","xl","lg","md","sm","xs"],de=["inherit","lg","md","sm"],St=["inherit","md","sm"],pe=["inherit","wrap","truncate"],_t=["gutter","inline"],Et=["hug","fill"],Tt=(r,a)=>a[r]||r,A=(r,a)=>r.filter(e=>a.includes(e)),ue=(r,a)=>{r&&(typeof r=="function"?r(a):r.current=a)},he=(r,a=0,e=100)=>Math.min(Math.max(r,a),e),$r=(r,a)=>r!==a,da=(r,a)=>r===a,ve=({a:r,b:a})=>$r(r?.top,a?.top)||$r(r?.left,a?.left)||$r(r?.width,a?.width)||$r(r?.height,a?.height);var n=sa(39291),b=sa(63820);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pa=globalThis,Ra=pa.ShadowRoot&&(pa.ShadyCSS===void 0||pa.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ma=Symbol(),me=new WeakMap;class ge{constructor(a,e,o){if(this._$cssResult$=!0,o!==Ma)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=a,this.t=e}get styleSheet(){let a=this.o;const e=this.t;if(Ra&&a===void 0){const o=e!==void 0&&e.length===1;o&&(a=me.get(e)),a===void 0&&((this.o=a=new CSSStyleSheet).replaceSync(this.cssText),o&&me.set(e,a))}return a}toString(){return this.cssText}}const jt=r=>new ge(typeof r=="string"?r:r+"",void 0,Ma),u=(r,...a)=>{const e=r.length===1?r[0]:a.reduce((o,i,c)=>o+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[c+1],r[0]);return new ge(e,r,Ma)},It=(r,a)=>{if(Ra)r.adoptedStyleSheets=a.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of a){const o=document.createElement("style"),i=pa.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=e.cssText,r.appendChild(o)}},fe=Ra?r=>r:r=>r instanceof CSSStyleSheet?(a=>{let e="";for(const o of a.cssRules)e+=o.cssText;return jt(e)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Pt,defineProperty:Lt,getOwnPropertyDescriptor:Rt,getOwnPropertyNames:Mt,getOwnPropertySymbols:Ot,getPrototypeOf:Bt}=Object,ua=globalThis,be=ua.trustedTypes,Ht=be?be.emptyScript:"",Nt=ua.reactiveElementPolyfillSupport,Xr=(r,a)=>r,Oa={toAttribute(r,a){switch(a){case Boolean:r=r?Ht:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,a){let e=r;switch(a){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},xe=(r,a)=>!Pt(r,a),$e={attribute:!0,type:String,converter:Oa,reflect:!1,useDefault:!1,hasChanged:xe};Symbol.metadata??=Symbol("metadata"),ua.litPropertyMetadata??=new WeakMap;class Ir extends HTMLElement{static addInitializer(a){this._$Ei(),(this.l??=[]).push(a)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(a,e=$e){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(a)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(a,e),!e.noAccessor){const o=Symbol(),i=this.getPropertyDescriptor(a,o,e);i!==void 0&&Lt(this.prototype,a,i)}}static getPropertyDescriptor(a,e,o){const{get:i,set:c}=Rt(this.prototype,a)??{get(){return this[e]},set(s){this[e]=s}};return{get:i,set(s){const d=i?.call(this);c?.call(this,s),this.requestUpdate(a,d,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(a){return this.elementProperties.get(a)??$e}static _$Ei(){if(this.hasOwnProperty(Xr("elementProperties")))return;const a=Bt(this);a.finalize(),a.l!==void 0&&(this.l=[...a.l]),this.elementProperties=new Map(a.elementProperties)}static finalize(){if(this.hasOwnProperty(Xr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Xr("properties"))){const e=this.properties,o=[...Mt(e),...Ot(e)];for(const i of o)this.createProperty(i,e[i])}const a=this[Symbol.metadata];if(a!==null){const e=litPropertyMetadata.get(a);if(e!==void 0)for(const[o,i]of e)this.elementProperties.set(o,i)}this._$Eh=new Map;for(const[e,o]of this.elementProperties){const i=this._$Eu(e,o);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(a){const e=[];if(Array.isArray(a)){const o=new Set(a.flat(1/0).reverse());for(const i of o)e.unshift(fe(i))}else a!==void 0&&e.push(fe(a));return e}static _$Eu(a,e){const o=e.attribute;return o===!1?void 0:typeof o=="string"?o:typeof a=="string"?a.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(a=>this.enableUpdating=a),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(a=>a(this))}addController(a){(this._$EO??=new Set).add(a),this.renderRoot!==void 0&&this.isConnected&&a.hostConnected?.()}removeController(a){this._$EO?.delete(a)}_$E_(){const a=new Map,e=this.constructor.elementProperties;for(const o of e.keys())this.hasOwnProperty(o)&&(a.set(o,this[o]),delete this[o]);a.size>0&&(this._$Ep=a)}createRenderRoot(){const a=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return It(a,this.constructor.elementStyles),a}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(a=>a.hostConnected?.())}enableUpdating(a){}disconnectedCallback(){this._$EO?.forEach(a=>a.hostDisconnected?.())}attributeChangedCallback(a,e,o){this._$AK(a,o)}_$ET(a,e){const o=this.constructor.elementProperties.get(a),i=this.constructor._$Eu(a,o);if(i!==void 0&&o.reflect===!0){const c=(o.converter?.toAttribute!==void 0?o.converter:Oa).toAttribute(e,o.type);this._$Em=a,c==null?this.removeAttribute(i):this.setAttribute(i,c),this._$Em=null}}_$AK(a,e){const o=this.constructor,i=o._$Eh.get(a);if(i!==void 0&&this._$Em!==i){const c=o.getPropertyOptions(i),s=typeof c.converter=="function"?{fromAttribute:c.converter}:c.converter?.fromAttribute!==void 0?c.converter:Oa;this._$Em=i;const d=s.fromAttribute(e,c.type);this[i]=d??this._$Ej?.get(i)??d,this._$Em=null}}requestUpdate(a,e,o){if(a!==void 0){const i=this.constructor,c=this[a];if(o??=i.getPropertyOptions(a),!((o.hasChanged??xe)(c,e)||o.useDefault&&o.reflect&&c===this._$Ej?.get(a)&&!this.hasAttribute(i._$Eu(a,o))))return;this.C(a,e,o)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(a,e,{useDefault:o,reflect:i,wrapped:c},s){o&&!(this._$Ej??=new Map).has(a)&&(this._$Ej.set(a,s??e??this[a]),c!==!0||s!==void 0)||(this._$AL.has(a)||(this.hasUpdated||o||(e=void 0),this._$AL.set(a,e)),i===!0&&this._$Em!==a&&(this._$Eq??=new Set).add(a))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const a=this.scheduleUpdate();return a!=null&&await a,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[i,c]of this._$Ep)this[i]=c;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,c]of o){const{wrapped:s}=c,d=this[i];s!==!0||this._$AL.has(i)||d===void 0||this.C(i,void 0,c,d)}}let a=!1;const e=this._$AL;try{a=this.shouldUpdate(e),a?(this.willUpdate(e),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(e)):this._$EM()}catch(o){throw a=!1,this._$EM(),o}a&&this._$AE(e)}willUpdate(a){}_$AE(a){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(a)),this.updated(a)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(a){return!0}update(a){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(a){}firstUpdated(a){}}Ir.elementStyles=[],Ir.shadowRootOptions={mode:"open"},Ir[Xr("elementProperties")]=new Map,Ir[Xr("finalized")]=new Map,Nt?.({ReactiveElement:Ir}),(ua.reactiveElementVersions??=[]).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ba=globalThis,ha=Ba.trustedTypes,ye=ha?ha.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ha="$lit$",lr=`lit$${Math.random().toFixed(9).slice(2)}$`,Na="?"+lr,Vt=`<${Na}>`,yr=document,qr=()=>yr.createComment(""),Wr=r=>r===null||typeof r!="object"&&typeof r!="function",Va=Array.isArray,we=r=>Va(r)||typeof r?.[Symbol.iterator]=="function",Da=`[ 	
\f\r]`,Kr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ae=/-->/g,ke=/>/g,wr=RegExp(`>|${Da}(?:([^\\s"'>=/]+)(${Da}*=${Da}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ze=/'/g,Ce=/"/g,Se=/^(?:script|style|textarea|title)$/i,Fa=r=>(a,...e)=>({_$litType$:r,strings:a,values:e}),uc=Fa(1),hc=Fa(2),vc=Fa(3),Pr=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),_e=new WeakMap,Ar=yr.createTreeWalker(yr,129);function Ee(r,a){if(!Va(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ye!==void 0?ye.createHTML(a):a}const Te=(r,a)=>{const e=r.length-1,o=[];let i,c=a===2?"<svg>":a===3?"<math>":"",s=Kr;for(let d=0;d<e;d++){const l=r[d];let p,g,m=-1,f=0;for(;f<l.length&&(s.lastIndex=f,g=s.exec(l),g!==null);)f=s.lastIndex,s===Kr?g[1]==="!--"?s=Ae:g[1]!==void 0?s=ke:g[2]!==void 0?(Se.test(g[2])&&(i=RegExp("</"+g[2],"g")),s=wr):g[3]!==void 0&&(s=wr):s===wr?g[0]===">"?(s=i??Kr,m=-1):g[1]===void 0?m=-2:(m=s.lastIndex-g[2].length,p=g[1],s=g[3]===void 0?wr:g[3]==='"'?Ce:ze):s===Ce||s===ze?s=wr:s===Ae||s===ke?s=Kr:(s=wr,i=void 0);const y=s===wr&&r[d+1].startsWith("/>")?" ":"";c+=s===Kr?l+Vt:m>=0?(o.push(p),l.slice(0,m)+Ha+l.slice(m)+lr+y):l+lr+(m===-2?d:y)}return[Ee(r,c+(r[e]||"<?>")+(a===2?"</svg>":a===3?"</math>":"")),o]};class Gr{constructor({strings:a,_$litType$:e},o){let i;this.parts=[];let c=0,s=0;const d=a.length-1,l=this.parts,[p,g]=Te(a,e);if(this.el=Gr.createElement(p,o),Ar.currentNode=this.el.content,e===2||e===3){const m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(i=Ar.nextNode())!==null&&l.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const m of i.getAttributeNames())if(m.endsWith(Ha)){const f=g[s++],y=i.getAttribute(m).split(lr),z=/([.?@])?(.*)/.exec(f);l.push({type:1,index:c,name:z[2],strings:y,ctor:z[1]==="."?Ie:z[1]==="?"?Pe:z[1]==="@"?Le:Jr}),i.removeAttribute(m)}else m.startsWith(lr)&&(l.push({type:6,index:c}),i.removeAttribute(m));if(Se.test(i.tagName)){const m=i.textContent.split(lr),f=m.length-1;if(f>0){i.textContent=ha?ha.emptyScript:"";for(let y=0;y<f;y++)i.append(m[y],qr()),Ar.nextNode(),l.push({type:2,index:++c});i.append(m[f],qr())}}}else if(i.nodeType===8)if(i.data===Na)l.push({type:2,index:c});else{let m=-1;for(;(m=i.data.indexOf(lr,m+1))!==-1;)l.push({type:7,index:c}),m+=lr.length-1}c++}}static createElement(a,e){const o=yr.createElement("template");return o.innerHTML=a,o}}function kr(r,a,e=r,o){if(a===Pr)return a;let i=o!==void 0?e._$Co?.[o]:e._$Cl;const c=Wr(a)?void 0:a._$litDirective$;return i?.constructor!==c&&(i?._$AO?.(!1),c===void 0?i=void 0:(i=new c(r),i._$AT(r,e,o)),o!==void 0?(e._$Co??=[])[o]=i:e._$Cl=i),i!==void 0&&(a=kr(r,i._$AS(r,a.values),i,o)),a}class je{constructor(a,e){this._$AV=[],this._$AN=void 0,this._$AD=a,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(a){const{el:{content:e},parts:o}=this._$AD,i=(a?.creationScope??yr).importNode(e,!0);Ar.currentNode=i;let c=Ar.nextNode(),s=0,d=0,l=o[0];for(;l!==void 0;){if(s===l.index){let p;l.type===2?p=new Lr(c,c.nextSibling,this,a):l.type===1?p=new l.ctor(c,l.name,l.strings,this,a):l.type===6&&(p=new Re(c,this,a)),this._$AV.push(p),l=o[++d]}s!==l?.index&&(c=Ar.nextNode(),s++)}return Ar.currentNode=yr,i}p(a){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(a,o,e),e+=o.strings.length-2):o._$AI(a[e])),e++}}class Lr{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(a,e,o,i){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=a,this._$AB=e,this._$AM=o,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let a=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&a?.nodeType===11&&(a=e.parentNode),a}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(a,e=this){a=kr(this,a,e),Wr(a)?a===N||a==null||a===""?(this._$AH!==N&&this._$AR(),this._$AH=N):a!==this._$AH&&a!==Pr&&this._(a):a._$litType$!==void 0?this.$(a):a.nodeType!==void 0?this.T(a):we(a)?this.k(a):this._(a)}O(a){return this._$AA.parentNode.insertBefore(a,this._$AB)}T(a){this._$AH!==a&&(this._$AR(),this._$AH=this.O(a))}_(a){this._$AH!==N&&Wr(this._$AH)?this._$AA.nextSibling.data=a:this.T(yr.createTextNode(a)),this._$AH=a}$(a){const{values:e,_$litType$:o}=a,i=typeof o=="number"?this._$AC(a):(o.el===void 0&&(o.el=Gr.createElement(Ee(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===i)this._$AH.p(e);else{const c=new je(i,this),s=c.u(this.options);c.p(e),this.T(s),this._$AH=c}}_$AC(a){let e=_e.get(a.strings);return e===void 0&&_e.set(a.strings,e=new Gr(a)),e}k(a){Va(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,i=0;for(const c of a)i===e.length?e.push(o=new Lr(this.O(qr()),this.O(qr()),this,this.options)):o=e[i],o._$AI(c),i++;i<e.length&&(this._$AR(o&&o._$AB.nextSibling,i),e.length=i)}_$AR(a=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);a!==this._$AB;){const o=a.nextSibling;a.remove(),a=o}}setConnected(a){this._$AM===void 0&&(this._$Cv=a,this._$AP?.(a))}}class Jr{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(a,e,o,i,c){this.type=1,this._$AH=N,this._$AN=void 0,this.element=a,this.name=e,this._$AM=i,this.options=c,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=N}_$AI(a,e=this,o,i){const c=this.strings;let s=!1;if(c===void 0)a=kr(this,a,e,0),s=!Wr(a)||a!==this._$AH&&a!==Pr,s&&(this._$AH=a);else{const d=a;let l,p;for(a=c[0],l=0;l<c.length-1;l++)p=kr(this,d[o+l],e,l),p===Pr&&(p=this._$AH[l]),s||=!Wr(p)||p!==this._$AH[l],p===N?a=N:a!==N&&(a+=(p??"")+c[l+1]),this._$AH[l]=p}s&&!i&&this.j(a)}j(a){a===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,a??"")}}class Ie extends Jr{constructor(){super(...arguments),this.type=3}j(a){this.element[this.name]=a===N?void 0:a}}class Pe extends Jr{constructor(){super(...arguments),this.type=4}j(a){this.element.toggleAttribute(this.name,!!a&&a!==N)}}class Le extends Jr{constructor(a,e,o,i,c){super(a,e,o,i,c),this.type=5}_$AI(a,e=this){if((a=kr(this,a,e,0)??N)===Pr)return;const o=this._$AH,i=a===N&&o!==N||a.capture!==o.capture||a.once!==o.once||a.passive!==o.passive,c=a!==N&&(o===N||i);i&&this.element.removeEventListener(this.name,this,o),c&&this.element.addEventListener(this.name,this,a),this._$AH=a}handleEvent(a){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,a):this._$AH.handleEvent(a)}}class Re{constructor(a,e,o){this.element=a,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(a){kr(this,a)}}const mc={M:Ha,P:lr,A:Na,C:1,L:Te,R:je,D:we,V:kr,I:Lr,H:Jr,N:Pe,U:Le,B:Ie,F:Re},Dt=Ba.litHtmlPolyfillSupport;Dt?.(Gr,Lr),(Ba.litHtmlVersions??=[]).push("3.3.1");const Ft=(r,a,e)=>{const o=e?.renderBefore??a;let i=o._$litPart$;if(i===void 0){const c=e?.renderBefore??null;o._$litPart$=i=new Lr(a.insertBefore(qr(),c),c,void 0,e??{})}return i._$AI(r),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ua=globalThis;class va extends Ir{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const a=super.createRenderRoot();return this.renderOptions.renderBefore??=a.firstChild,a}update(a){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(a),this._$Do=Ft(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Pr}}va._$litElement$=!0,va.finalized=!0,Ua.litElementHydrateSupport?.({LitElement:va});const Ut=Ua.litElementPolyfillSupport;Ut?.({LitElement:va});const gc={_$AK:(r,a,e)=>{r._$AK(a,e)},_$AL:r=>r._$AL};(Ua.litElementVersions??=[]).push("4.2.1");const Me={};function S(r,a){if(typeof document<"u"&&a?.styleSheet){const e=Me[r];Me[r]=a.styleSheet,document.adoptedStyleSheets=[...document.adoptedStyleSheets.filter(o=>o!==e),a.styleSheet]}}const x=u`arc•avatar`,R=u`arc•modifier`,D=u`${x}•computed`,ir=u`${x}•mask`,Yt=r=>r?.trim().charAt(0)??void 0,Zt=(r,a)=>{let e=0;const o=Math.min(r.length,50);for(let i=0;i<o;i+=1)e=(e+r.charCodeAt(i))%(a??33);return e},Xt=(r,a,e)=>a?.length?r?.trim()===""?e||a[0]:a[Zt(r,a.length)]||e||a[0]:e,Oe=A(Ia,["blue","orange","mint","red","yellow","green","maroon","purple"]),qt=A(Ia,["neutral","white","black"]),ma=A(er,["lg","md","sm","xs"]),Wt=[...ma,"profile-sm","profile-md","profile-lg"],Kt=de,Gt=pe,Jt=ma,Qt=ma,ro=ma,Ya=u`
...
[arc-avatar] {
  ...
  --${D}-font-size: calc(var(--${R}-px));
  --${D}-size: calc(var(--${x}-size) / var(--${R}-em));
  --${D}-num-size-1: calc(var(--${x}-num-size-1) / var(--${R}-em));
  --${D}-num-size-2: calc(var(--${x}-num-size-2) / var(--${R}-em));
  --${D}-num-size-3: calc(var(--${x}-num-size-3) / var(--${R}-em));
}

/* CORE AVATAR STYLES ----------------------------------------------• */

[arc-avatar] {
  font-size: var(--arc-avatar-font-size, var(--${D}-font-size));
  ...
  [data-num-length] {
    --arc-button-font-size: var(--${D}-num-size-1);
  }

  [data-num-length='2'] {
    --arc-button-font-size: var(--${D}-num-size-2);
  }

  [data-num-length='3'] {
    --arc-button-font-size: var(--${D}-num-size-3);
  }
...
`,no=r=>typeof r=="number"?`calc(${r/10}rem * var(--arc-internal-font-size))`:r,I=({children:r,icon:a="fa-regular fa-circle-dashed",color:e,size:o,style:i,...c})=>{const s={...i,"--arc-icon-size":no(o),"--arc-icon-color":e},d=!!(c["aria-label"]||c["aria-labelledby"]),l=typeof a=="string"&&a.length>0?(0,n.jsx)("span",{className:a}):a;return(0,n.jsx)("span",{"aria-hidden":!d||void 0,...c,"arc-icon":"",style:s,children:r||l})};I.Articulate=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(He,{})}),I.AI=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(Ne,{})}),I.Peek=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(Ve,{})}),I.Reach=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(De,{})}),I.Review=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(Fe,{})}),I.Rise=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(Ue,{})}),I.Storyline=r=>(0,n.jsx)(I,{...r,icon:(0,n.jsx)(Ye,{})}),S("ArcIcon",oo);const io=({children:r,icon:a,color:e,...o})=>(0,n.jsx)("span",{...o,"data-element":"anonymous","data-color":"neutral",children:r||(0,n.jsx)(I,{icon:a})}),Ze="blue",Xe="neutral",co="fa-solid fa-user",Za=(0,b.forwardRef)(({children:r,size:a,color:e,isActive:o=!0,isAnonymous:i,alt:c,src:s,name:d,email:l,...p},g)=>{const[m,f]=(0,b.useState)(!1),[y,z]=(0,b.useState)(!1),C=Z=>{f(!0),z(!1),p.onLoad?.(Z)},L=Z=>{f(!1),z(!0),p.onError?.(Z)},T=Yt(d||l),w=!!T,$=i||(!m||y)&&!w,j=!$&&!!s&&!y||void 0,B=($&&Xe||void 0)??(e||void 0)??Xt(String(l||d||void 0),Oe,Ze)??Ze,H={src:s,alt:c,isLoaded:m,hasError:y,onLoad:C,onError:L};return(0,b.useEffect)(()=>{$&&f(!1)},[$]),(0,n.jsx)("span",{...p,ref:g,"arc-avatar":"","data-is-inactive":!o||void 0,"data-size":a,"aria-label":(p.title??d??l)||void 0,children:r||($?(0,n.jsx)(io,{icon:co,color:Xe}):(0,n.jsxs)(n.Fragment,{children:[j&&(0,n.jsx)(to,{...H}),w&&(0,n.jsx)(eo,{initial:T,color:B})]}))})});S("ArcAvatar",ao);const X=u`${x}•text`,fr=u`${x}•subtext`,Rr=u`${x}•gap`,so=u`
@layer arc-components {

  [arc-avatar-text] {
    --${X}-font-size: max(var(--arc-font-size-14), 0.875em); /* 14px @ 100% */
    --${fr}-font-size: max(var(--arc-font-size-12), 0.75em); /* 12px @ 100% */
    --${Rr}: max(var(--arc-space-1), 0.5em); /* 8px @ 100% */

    --${X}-overflow: unset;
    --${X}-text-overflow: unset;
    --${X}-white-space: unset;
    ...
    &:has([data-size=inherit]) {
      --${X}-font-size: 1em;
      --${fr}-font-size: 0.875em;
      --${Rr}: 0.5em;
    }

    &:has([data-size=lg]) {
      --${X}-font-size: var(--arc-font-size-14);
    ...
    &:has([data-size=xs]) {
      --${X}-font-size: var(--arc-font-size-12);
      --${fr}-font-size: var(--arc-font-size-12);
      --${Rr}: var(--arc-space-0-75);
    }

    &[data-gap=lg] { --${Rr}: var(--arc-space-1-5); }
    &[data-gap=sm] { --${Rr}: var(--arc-space-0-5); }
  }

  [arc-avatar-text] {
    font-size: var(--${X}-font-size, inherit);
    display: inline-flex;
    align-items: center;
    gap: var(--${Rr});
    line-height: normal;
    ...
    [data-element=subtext] {
      display: block;
      font-size: var(--arc-avatar-subtext-font-size, var(--${fr}-font-size));
      color: var(--arc-avatar-subtext-color, var(--${fr}-color, color-mix(in srgb, currentcolor 61%, transparent)));
    }

    :where([data-element=text], [data-element=subtext]) {
      overflow: var(--${X}-overflow);
      text-overflow: var(--${X}-text-overflow);
      white-space: var(--${X}-white-space);
    }
  }

}
`,lo="Anonymous",Xa=({children:r,avatar:a={},subtext:e,size:o,gapSize:i,overflow:c,isStrong:s,...d})=>{const l=a.anonymousName||lo,p=a.name||a.email||a.src,g=a.name||a.email,m=a.isAnonymous||!p,f=r||m?l:g,y=i!=="inherit"?i:void 0,z=c!=="inherit"?c:void 0;return(0,n.jsxs)("span",{...d,"arc-avatar-text":"","data-gap":y,"data-overflow":z,"is-strong":s?"":void 0,children:[(0,n.jsx)(Za,{...a,isAnonymous:m,size:o}),(0,n.jsxs)("span",{"data-element":"text",children:[f,e&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("br",{}),(0,n.jsx)("small",{"data-element":"subtext",children:e})]})]})]})};S("ArcAvatarText",so);const po=u`
@layer arc-components {
  ...
  [arc-avatar-pile] {
    ...
    */
    ...
    --${R}-em: var(--${R}) * 1em;
    --${D}-offset: calc(2 / var(--${R}-em));
    --${D}-mask-shift: calc(-2 / var(--${R}-em));

    --${ir}-position: 50% 50% at calc(-50% + var(--${D}-offset)) 50%;
    --${ir}-sharpness: min(var(--${D}-offset), 0.015em);
    --${ir}-hide: transparent calc(100% + var(--${D}-offset));
    --${ir}-show: black calc(100% + var(--${ir}-sharpness) + var(--${D}-offset));
...
`,uo=({size:r="md",...a})=>(0,n.jsx)("div",{...a,"arc-avatar-pile":"","data-size":r});S("ArcAvatarPile",po);const Qr=r=>typeof r=="string"?r:typeof r=="number"?r.toString():Array.isArray(r)?r.map(Qr).join(""):(0,b.isValidElement)(r)?Qr(r.props.children):"",ho=()=>Math.random().toString(16).slice(-6),dr=r=>`${r||"id"}-${ho()}`,qe=[...Pa],vo=[...la],qa=A(q,["common"]),mo=A(q,["ai","brand"]),We=["top-start","top-center","top-end","left-start","right-start","left-center","center","right-center","left-end","right-end","bottom-start","bottom-center","bottom-end"],Ke=["ignore","flip"],k={Threshold:0,StartX:{align:"start",y:"y1",oY:"ch",xMod:-1,yMod:1},StartY:{align:"start",x:"x1",oX:"cw",xMod:-1,yMod:1},CenterX:{align:"center",y:"cy",oY:"z",xMod:-1,yMod:1},CenterY:{align:"center",x:"cx",oX:"z",xMod:1,yMod:-1},EndX:{align:"end",y:"y2",oY:"ch",xMod:1,yMod:-1},EndY:{align:"end",x:"x2",oX:"cw",xMod:1,yMod:-1},Top:{edge:"top",y:"top",pX:"z",pY:"ch",oY:"z",pMod:-1},Bottom:{edge:"bottom",y:"bottom",pX:"z",pY:"ch",oY:"z",pMod:1},Right:{edge:"right",x:"right",pX:"cw",pY:"z",oX:"z",pMod:1},Left:{edge:"left",x:"left",pX:"cw",pY:"z",oX:"z",pMod:-1},Center:{edge:"center",pX:"cw",pY:"ch",pMod:0}},tr=(r,a,e)=>e==="left"&&r.a.left>=r.v.threshold&&r.a.left-r.p.width+a.x>=r.v.threshold||e==="top"&&r.a.top>=r.v.threshold&&r.a.top-r.p.height+a.y>=r.v.threshold||e==="right"&&r.a.right<=r.v.width-r.v.threshold&&r.a.right+r.p.width+a.x<=r.v.width-r.v.threshold||e==="bottom"&&r.a.bottom<=r.v.height-r.v.threshold&&r.a.bottom+r.p.height+a.y<=r.v.height-r.v.threshold,Ge=(r,a)=>r.a.top+r.p.height+a.y<=r.v.height-r.v.threshold&&r.a.top>=r.v.threshold,Je=(r,a)=>r.a.left+r.p.width+a.x<=r.v.width-r.v.threshold&&r.a.left>=r.v.threshold,Qe=(r,a)=>r.a.cy+r.p.ch+a.y<=r.v.height-r.v.threshold&&r.a.cy-r.p.ch+a.y>=r.v.threshold,rt=(r,a)=>r.a.cx+r.p.cw+a.x<=r.v.width-r.v.threshold&&r.a.cx-r.p.cw+a.x>=r.v.threshold,at=(r,a)=>r.a.bottom<=r.v.height-r.v.threshold&&r.a.bottom-r.p.height+a.y>=r.v.threshold,et=(r,a)=>r.a.right<=r.v.width-r.v.threshold&&r.a.right-r.p.width+a.x>=r.v.threshold,ra={"top-start":{...k.Top,...k.StartY,fitCheck:(r,a)=>tr(r,a,k.Top.edge)&&Je(r,a),flip:"bottom-start"},"top-center":{...k.Top,...k.CenterY,fitCheck:(r,a)=>tr(r,a,k.Top.edge)&&rt(r,a),flip:"bottom-center"},"top-end":{...k.Top,...k.EndY,fitCheck:(r,a)=>tr(r,a,k.Top.edge)&&et(r,a),flip:"bottom-end"},"right-start":{...k.Right,...k.StartX,fitCheck:(r,a)=>tr(r,a,k.Right.edge)&&Ge(r,a),flip:"left-start"},"right-center":{...k.Right,...k.CenterX,fitCheck:(r,a)=>tr(r,a,k.Right.edge)&&Qe(r,a),flip:"left-center"},"right-end":{...k.Right,...k.EndX,fitCheck:(r,a)=>tr(r,a,k.Right.edge)&&at(r,a),flip:"left-end"},center:{...k.Center,...k.CenterX,...k.CenterY,fitCheck:(r,a)=>r.a.cx-r.p.cw+a.x>=r.v.threshold&&r.a.cx+r.p.cw+a.x<=r.v.width-r.v.threshold&&r.a.cy-r.p.ch+a.y>=r.v.threshold&&r.a.cy+r.p.ch+a.y<=r.v.height-r.v.threshold,flip:"center"},"bottom-start":{...k.Bottom,...k.StartY,fitCheck:(r,a)=>tr(r,a,k.Bottom.edge)&&Je(r,a),flip:"top-start"},"bottom-center":{...k.Bottom,...k.CenterY,fitCheck:(r,a)=>tr(r,a,k.Bottom.edge)&&rt(r,a),flip:"top-center"},"bottom-end":{...k.Bottom,...k.EndY,fitCheck:(r,a)=>tr(r,a,k.Bottom.edge)&&et(r,a),flip:"top-end"},"left-start":{...k.Left,...k.StartX,fitCheck:(r,a)=>tr(r,a,k.Left.edge)&&Ge(r,a),flip:"right-start"},"left-center":{...k.Left,...k.CenterX,fitCheck:(r,a)=>tr(r,a,k.Left.edge)&&Qe(r,a),flip:"right-center"},"left-end":{...k.Left,...k.EndX,fitCheck:(r,a)=>tr(r,a,k.Left.edge)&&at(r,a),flip:"right-end"}},or={popover:qe[0],anchorAt:We[10],boundary:Ke[0],variant:qa[0],isInverse:!1,hasTail:!1,tailSize:10,threshold:0,offset:0},ga=(r,a="arc-popover")=>r||dr(a),go=(r=or.threshold)=>({threshold:r,width:document.documentElement.clientWidth,height:document.documentElement.clientHeight,scrollX:window.scrollX,scrollY:window.scrollY,left:window.scrollX,top:window.scrollY,right:window.scrollX+document.documentElement.clientWidth,bottom:window.scrollY+document.documentElement.clientHeight}),tt=r=>({...JSON.parse(JSON.stringify(r)),cw:r.width/2,ch:r.height/2,cx:r.left+r.width/2,cy:r.top+r.height/2,x1:r.left,x2:r.left+r.width,y1:r.top,y2:r.top+r.height,z:0}),fo=(r,a,e=or.offset,o=or.tailSize,i=or.threshold)=>({a:tt(r?.getBoundingClientRect()??new DOMRect),p:tt(a?.getBoundingClientRect()??new DOMRect),o:e,v:go(i),t:o}),ot=(r,a,e)=>({x:["left","right"].includes(r)?a*e:0,y:["top","bottom"].includes(r)?a*e:0}),bo=(r,a)=>[...Object.keys(ra)].filter(e=>$r(e,r)&&$r(a.align,"center")?!e.includes("center"):e).sort((e,o)=>{const i=da(ra[e].edge,a.edge),c=da(ra[o].edge,a.edge),s=i?-1:1;return da(i,c)?0:s}),nt=({anchorAt:r,measurements:a})=>{const e=ra[r],o=ot(e.edge,a.o,e.pMod);return{cx:a.a.cx,cy:a.a.cy,offsets:o,config:e}},xo=({anchorAt:r,measurements:a})=>{const{offsets:e,config:o}=nt({anchorAt:r,measurements:a});return o.fitCheck(a,e)?r:[o.flip,...bo(r,o)].find(i=>{const c=ra[i],s=ot(c.edge,a.o,c.pMod);return c.fitCheck(a,s)})??r},pr=(r,a="px")=>`${r}${a}`,Wa=({anchorElement:r,popoverElement:a,anchorAt:e=or.anchorAt,boundary:o,offset:i,tailSize:c,threshold:s=k.Threshold})=>{const d=e,l=fo(r,a,i,c,s),p=o==="flip"?xo({anchorAt:d,measurements:l}):d,{cx:g,cy:m}=nt({anchorAt:p,measurements:l}),f={cx:g,cy:m},y=r?.dataset?.layout==="icon"||l.t>0||!e?.includes("-center")&&(e?.includes("left-")||e?.includes("right-"));return{anchorAt:p,vars:{"--js-cx":pr((f.cx+window.scrollX).toFixed(2)),"--js-cy":pr((f.cy+window.scrollY).toFixed(2)),"--js-w":pr(l.a.width.toFixed(2)),"--js-h":pr(l.a.height.toFixed(2)),"--js-cw":pr(l.a.cw.toFixed(2)),"--js-ch":pr(l.a.ch.toFixed(2)),"--js-o":pr(l.o.toFixed(2)),"--js-t":pr(l.t,""),"--js-i":y?"1":"0","--js-m":pr(he(l.t,l.a.height,l.a.cw).toFixed(2))}}},it=(r,a=1/0,e=" ")=>[...r].flat(a)?.filter(Boolean)?.join(e),ur=u`arc•icon•text`,M=u`${ur}•icon`,P=u`${ur}•text`,Mr=u`${ur}•subtext`,hr=u`${ur}•gap`,$o=u`
...
`,yo=u`
  ...
  &[icon-size=xl] { --${M}-size: max(var(--arc-font-size-24), 1.5em); }
  &[icon-size=lg] { --${M}-size: max(var(--arc-font-size-20), 1.25em); }
  &[icon-size=md] { --${M}-size: max(var(--arc-font-size-16), 1em); }
  &[icon-size=sm] { --${M}-size: max(var(--arc-font-size-14), 0.75em); }
  &[icon-size=xs] { --${M}-size: max(var(--arc-font-size-12), 0.625em); }
`,wo=u`

  /* 61.2% is the opacity equivalent of the secondary-text color token's gray value. */
  --${Mr}-color: var(--arc-icon-text-subtext-color, color-mix(in srgb, currentcolor 61.2%, transparent));

  /* ArcIcon */
  --arc-icon-color: var(--arc-icon-text-icon-color, var(--${M}-color));
  --arc-icon-size: var(--arc-icon-text-icon-size, var(--${M}-size));
  ...
  &[data-layout=inline] {
    ...
    --${M}-vertical-align: calc((var(--${M}-size) - var(--${ur}-font-size)) / -2);

    &:has(svg) { --${M}-vertical-align: text-bottom; }
  }
  ...
  [arc-icon-text] {
    ...
    &[data-layout=gutter] {
      ...
      [data-element=subtext] {
        display: block;
        line-height: normal;
        font-size: var(--arc-icon-text-subtext-font-size, var(--${Mr}-font-size));
        color: var(--arc-icon-text-subtext-color, var(--${Mr}-color));
    ...
    &[data-layout=inline] {
      ...
      [data-element=icon] {
        line-height: normal;
        vertical-align: var(--arc-icon-text-icon-vertical-align, var(--${M}-vertical-align));
      }
      ...
      &:has(svg) {
        --${M}-vertical-align: text-bottom;
      }
    }
  }
}

`,ko=A(q,["inherit","primary","secondary","inverse","brand","info","success","warning","critical"]),cr=({children:r,layout:a="gutter",size:e="inherit",variant:o="inherit",tag:i="span",icon:c,text:s,subtext:d,overflow:l,iconSize:p,gapSize:g,isFlipped:m=!1,isStrong:f=!1,...y})=>{const z=r||s,C=!!c,L=!!z,T=a==="gutter",w=a==="inline",$=C&&(!m||T),j=C&&L&&m&&w,B=!!p&&p!=="inherit",H=B&&La.includes(p)?p:void 0,Z=B&&!La.includes(p)?p:void 0,nr=g!=="inherit"?g:void 0,rr=l!=="inherit"?l:void 0;return(0,n.jsxs)(i,{...y,"arc-icon-text":"","data-variant":o,"data-layout":a,"data-overflow":rr,"data-size":e,"data-gap":nr,"icon-size":H,"is-flipped":m?"":void 0,"is-strong":f?"":void 0,children:[$&&(0,n.jsx)(I,{"data-element":"icon",icon:c,size:Z}),L&&(0,n.jsxs)("span",{"data-element":"text",children:[z,!!d&&(T?(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("br",{}),(0,n.jsx)("small",{"data-element":"subtext",children:d})]}):(0,n.jsxs)(n.Fragment,{children:[" ",(0,n.jsx)("span",{"data-element":"subtext",children:d})]}))]}),j&&(0,n.jsx)(I,{"data-element":"icon",icon:c,size:Z})]})};S("ArcIconText",Ao);const vr={...or,popover:"manual",anchorAt:"top-center",boundary:"flip",variant:"common",tailSize:8,offset:4,isInverse:!0,isStrong:!0,hasTail:!0};let fa=!1;const zo=100,Co=100;let Ka=!0,Ga=null;const So=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("selector(:focus-visible)"),_o=r=>r instanceof Element?So?r.matches(":focus-visible")===!0:Ka:!1,Ja=new WeakMap,Qa=new WeakMap,ba=(r,a)=>{const e=r.get(a);e!=null&&(clearTimeout(e),r.delete(a))},ct=(r,a,e,o)=>{const i=window.setTimeout(()=>{o(),r.delete(a)},e);r.set(a,i)},st="[aria-describedby]",Eo=r=>typeof r=="object"&&r!==null&&r.hasAttribute?.("popover")===!0,lt=r=>r instanceof HTMLElement&&r.getAttribute("role")==="tooltip"&&Eo(r),To=r=>!!r&&(r.tagName==="LABEL"||r.hasAttribute("arc-label")),jo=r=>r?.match(/\S+/g)??[],re=r=>{if(typeof document>"u")return null;const a=document.querySelector(`[aria-describedby~="${r}"]`);return a?a.closest("label,[arc-label]")??a:null},Io=r=>{if(!(r instanceof Element))return null;const a=r.closest?.(st);if(a){const o=a.getAttribute("aria-describedby")??"";if(o)return{anchor:a.closest?.("label,[arc-label]")??a,tooltipId:o}}let e=r;for(;e;){if(To(e)){const o=e.querySelector?.(st),i=o?.getAttribute?.("aria-describedby")??"";if(o&&i)return{anchor:e,tooltipId:i}}e=e.parentElement}return null},Po=r=>{if(!(r instanceof Element))return null;const a=r.closest?.('[role="tooltip"]')??null;return a instanceof HTMLElement?a:null},Lo=r=>r?.id?re(r.id):null,Ro=r=>{const a=Po(r),e=Io(r);if(!e&&a){const d=Lo(a);return!d||!a.id?null:{anchor:d,tooltip:a}}if(!e)return null;const{anchor:o,tooltipId:i}=e;if(!i)return null;const c=jo(i),s=a??c.map(d=>document.getElementById(d)).find(d=>lt(d))??null;return lt(s)?{anchor:o,tooltip:s}:null},Mo=(r,a,e)=>{const o=e instanceof Element?e:null;if(!o)return!1;const i=r===o||r.contains(o),c=a===o||a.contains(o);return i||c},Oo=(r,a)=>{if(ba(Qa,r),ba(Ja,r),!a){r.showPopover?.();return}ct(Ja,r,zo,()=>{r.showPopover?.()})},Bo=(r,a)=>{if(ba(Ja,r),ba(Qa,r),!a){r.hidePopover?.();return}ct(Qa,r,Co,()=>{r.hidePopover?.()})},aa=(r,a,e,o)=>{const i=Ro(a);if(!i)return;const{anchor:c,tooltip:s}=i;if(r){Oo(s,o);return}Mo(c,s,e)||Bo(s,o)};let xa=null,$a=null,ya=null,wa=null,Aa=null,ka=null,Or=null;const dt=()=>{fa||typeof document>"u"||(ka=r=>{Ka=!1,Ga=r.target},Or=()=>{Ga=null},xa=r=>aa(!0,r.target,void 0,!0),$a=r=>{_o(r.target)&&aa(!0,r.target,void 0,!1)},ya=r=>aa(!1,r.target,r.relatedTarget,!0),wa=r=>{const a=r.relatedTarget??Ga;aa(!1,r.target,a,!1)},Aa=r=>{r.key==="Tab"&&(Ka=!0),r.key==="Escape"&&aa(!1,r.target,void 0,!1)},document.addEventListener("pointerdown",ka),document.addEventListener("pointerup",Or),document.addEventListener("pointercancel",Or),document.addEventListener("pointerover",xa),document.addEventListener("focusin",$a),document.addEventListener("pointerout",ya),document.addEventListener("focusout",wa),document.addEventListener("keydown",Aa),fa=!0)},Ho=()=>{if(!fa||typeof document>"u")return;[["pointerdown",ka],["pointerup",Or],["pointercancel",Or],["pointerover",xa],["focusin",$a],["pointerout",ya],["focusout",wa],["keydown",Aa]].forEach(([a,e])=>{e&&document.removeEventListener(a,e)}),xa=null,$a=null,ya=null,wa=null,Aa=null,ka=null,Or=null,fa=!1},No=u`
@layer arc-components {
  [arc-tooltip] {
...
`,pt=(0,b.forwardRef)(({id:r,children:a,slot:e,anchorAt:o=vr.anchorAt,boundary:i=vr.boundary,hasTail:c=vr.hasTail,tailSize:s=vr.tailSize,offset:d=vr.offset,isStrong:l=vr.isStrong,text:p,subtext:g,icon:m,isFlipped:f,...y},z)=>{try{dt()}catch{}const C=(0,b.useMemo)(()=>ga(r,"arc-tooltip"),[r]),L=B=>typeof B=="object"&&B!==null&&"tabIndex"in B,T=a,w=!!y.alternateAnchor;let $=null;(0,b.isValidElement)(T)?$=(0,b.cloneElement)(T,{"aria-describedby":C,...L(T.props)&&T.props.tabIndex!=null?{}:{tabIndex:0}}):!w&&typeof console<"u"&&console.warn("ArcTooltip expects a single ReactElement child as the trigger.");const j=(0,b.useMemo)(()=>()=>re(C),[C]);return(0,n.jsxs)(n.Fragment,{children:[$,(0,n.jsxs)(oa,{...y,"arc-tooltip":"",role:"tooltip",id:C,ref:z,popover:vr.popover,anchorAt:o,boundary:i,variant:vr.variant,isInverse:!0,hasTail:c,tailSize:s,offset:d,hidePopoverButton:!0,alternateAnchor:y.alternateAnchor??j,children:[p&&(0,n.jsx)(cr,{"arc-tooltip-content":"",text:p,subtext:g,icon:m,isFlipped:f,isStrong:l,size:"inherit",variant:"inherit"}),e&&(0,n.jsx)("span",{"arc-tooltip-slot-content":"",children:e})]})]})});S("ArcTooltip",No);const Vo=A(ja,["circle","square","narrow"]),Do=A(er,["xxl","xl","lg","md","sm"]),Fo=A(sr,["hug","fill","icon"]),Uo=A(q,["common","ai","critical"]),ut=A(q,["primary","secondary","tertiary","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse"]),Yo=A(ce,["primary","secondary","tertiary","plain"]),Zo=[...la],t=u`arc•button`,O=u`arc•modifier`,_=u`${t}•computed`,Xo=u`
  &[data-size=xxl] {
    --${O}: 16; /* unitless, desired font size at 100% */
    --${t}-icon-size: 20;
    --${t}-spinner-size: 32;
    --${t}-height: 56;
    --${t}-gap: 10;
  ...
  &[data-size=xl] {
    --${O}: 14; /* unitless, desired font size at 100% */
    --${t}-icon-size: 16;
    --${t}-spinner-size: 16;
    --${t}-height: 48;
    --${t}-gap: 8;
  ...
  &[data-size=sm] {
    --${O}: 12; /* unitless, desired font size at 100% */
    --${t}-icon-size: 12;
    --${t}-spinner-size: 14;
    --${t}-height: 24;
    --${t}-gap: 4;
...
`,Qo=u`
  ...
  --${O}-base: var(--${O}) * var(--${O}-unit, 1px);
  --${O}-em: var(--${O}) * 1em;

  /* COMPUTED */

  --${_}-font-size: calc(var(--${O}-base));
  --${_}-icon-size: calc(var(--${t}-icon-size) / var(--${O}-em));
  --${_}-border-size: max(var(--arc-border-width-sm), calc(1 / var(--${O}-em)));
  --${_}-outline-size: max(var(--arc-border-width-md), calc(2 / var(--${O}-em)));
  --${_}-border-radius-md: max(var(--arc-border-radius-md), calc(4 / var(--${O}-em)));
  --${_}-height: calc(var(--${t}-height) / var(--${O}-em));
  --${_}-padding: 0 calc(var(--${t}-padding-inline) / var(--${O}-em));
  --${_}-spinner-size: calc(var(--${t}-spinner-size) / var(--${O}-em));
  --${_}-gap: max(var(--arc-space-0-5), calc(var(--${t}-gap) / var(--${O}-em)));
  ...
  &[data-variant^=ai-] {
    --${_}-border-size: max(var(--arc-border-width-md), calc(2 / var(--${O}-em)));
  }
...
`,an=u`
  ...
  [arc-button=custom] {
    ...
    --${O}: 14; /* unitless, desired font size at 100% */
    --${O}-unit: 0.0625em; /* 1/16th of an em for the computed calcs */
    --${t}-icon-size: 16;
    --${t}-gap: 8;
...
`,en=(0,n.jsxs)("svg",{viewBox:"0 0 100 100","arc-spinner":"",children:[(0,n.jsx)("circle",{"arc-spinner-circle":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"}),(0,n.jsx)("circle",{"arc-spinner-progress":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"})]}),zr=(0,b.forwardRef)(({children:r,disabled:a,...e},o)=>{const i=(0,b.useRef)(null),{iconEnd:c,iconStart:s,icon:d,text:l,isActive:p,isDisabled:g,isProcessing:m,tag:f,href:y,type:z,title:C,layout:L,shape:T,size:w="lg",variant:$="common",hierarchy:j="primary",isInverse:B=!1,_isCustom:H,...Z}=e,nr=$&&ut.includes($),rr=(()=>{if(nr||!["common","critical","ai"].includes($))return $;const Zr=j||"primary";return $==="common"?B?`${Zr}-inverse`:Zr:`${$}-${Zr}`})(),Dr=L==="icon",mr=f??(y?"a":"button"),oe=mr==="button"?z||"button":void 0,Fr=m||g||a,_r=s||d,_a=!Dr&&(r||l),Ur=!Dr&&c,{tooltip:Ea,...ca}=Z,Yr=typeof Ea=="string"?Ea:void 0,br=e.tooltip??Yr,gr=!!br,Er=typeof br=="string"?{text:br}:br,K=Z["aria-describedby"],ar=(0,b.useRef)(void 0);gr&&!ar.current&&(ar.current=e.id?`${e.id}-tooltip`:ga(void 0,"arc-tooltip"));const xr=gr?it([K,ar.current]):K,{popoverTarget:Tr,popoverTargetAction:jr,...Ta}=ca;let Ct={popoverTarget:Tr||void 0,popoverTargetAction:jr||void 0};return b.version.startsWith("18")&&(Ct={popovertarget:Tr||void 0,popovertargetaction:jr||void 0}),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(mr,{...Ta,...Ct,ref:Zr=>{i.current=Zr,ue(o,Zr)},"arc-button":H?"custom":"",disabled:!y&&Fr||void 0,href:y||void 0,title:gr?void 0:C||void 0,type:oe,"data-layout":L,"data-shape":H?void 0:T,"data-size":H?void 0:w,"data-variant":H?void 0:rr,"is-active":p?"":void 0,"is-processing":m?"":void 0,"is-disabled":Fr?"":void 0,"aria-disabled":Fr||void 0,"aria-describedby":xr||void 0,children:[(0,n.jsxs)("span",{"arc-button-content":"",children:[!!_r&&(0,n.jsx)(I,{"arc-button-icon":"",icon:_r}),!!_a&&(0,n.jsx)("span",{"arc-button-label":"",children:_a}),!!Ur&&(0,n.jsx)(I,{"arc-button-icon":"",icon:c})]}),m&&en]}),gr&&(0,n.jsx)(pt,{...Er,id:ar.current,alternateAnchor:Er?.alternateAnchor??(()=>i.current)})]})});zr.displayName="ArcButton",S("ArcButton",an);const ea=(0,b.forwardRef)((r,a)=>(0,n.jsx)(zr,{...r,ref:a,"arc-popover-button":""})),ht=({isInverse:r=!1,isOpen:a,...e})=>(0,n.jsx)(zr,{...e,icon:"fa-regular fa-xmark fa-fw",text:"Dismiss",layout:"icon",shape:"square",size:"sm",variant:"common",hierarchy:"tertiary",isInverse:r,"arc-popover-dismiss":""}),tn=({children:r,showDismiss:a,dismissProps:e,tag:o="header",...i})=>(0,n.jsxs)(o,{...i,"arc-popover-header":"",children:[r,a&&(0,n.jsx)(ht,{...e})]}),on=({tag:r="article",...a})=>(0,n.jsx)(r,{...a,"arc-popover-body":""}),nn=({showDivider:r,tag:a="footer",...e})=>(0,n.jsx)(a,{...e,"arc-popover-footer":"","has-divider":r?"":void 0}),cn=r=>(0,n.jsx)("span",{...r,"arc-popover-tail":""});ea.displayName="ArcPopoverButton";const h=u`arc•popover`,E=u`${h}•space`,G=u`${h}•shift`,Br=u`${h}•offset`,W=u`${h}•outline`,vt=u`${h}•header`,za=u`${h}•body`,ta=u`${h}•footer`,v=u`${h}•tail`,sn=u`
  --${h}-border-radius: var(--arc-popover-border-radius, var(--arc-border-radius-lg));
  --${h}-inner-border-radius: calc(var(--${h}-border-radius) - var(--${W}-size));
  ...
  --${E}-1: max(1px, 0.0625em);
  --${E}-2: max(2px, 0.125em);
  --${E}-3: max(3px, 0.1875em);
  --${E}-4: max(4px, 0.25em);
  --${E}-6: max(6px, 0.375em);
  --${E}-8: max(8px, 0.5em);
  --${E}-10: max(10px, 0.625em);
  --${E}-12: max(12px, 0.75em);
  --${E}-16: max(16px, 1em);
  --${E}-20: max(20px, 1.25em);
  --${E}-24: max(24px, 1.5em);

  --${W}-size: var(--arc-popover-outline-size, var(--${E}-2));

  /* tail metrics */
  --${v}-base: max(var(--js-t, 10) * 1px, 0.625em);
  --${v}-size: (var(--${v}-base) + var(--${W}-size));

  /* 0.707 = sqrt(2)/2 = multiplier for half of rotated tail size (used in offset calcs) */
  --${v}-shift: (var(--${v}-base) * 0.707 * var(--js-i));

  /* offset */
  --${Br}-x: calc(var(--js-cw) + var(--js-o) + var(--arc-popover-nudge, 0em));
  --${Br}-y: calc(var(--js-ch) + var(--js-o) + var(--arc-popover-nudge, 0em));
  --${G}-x: calc(var(--js-cw) + var(--${v}-shift));
  --${G}-y: calc(var(--js-ch) + var(--${v}-shift));
  ...
  &:has([arc-popover-body]) {
    --${h}-padding: 0;
    &:has([arc-popover-header]) { --${za}-padding-block-start: 0; }
    &:has([arc-popover-footer]:not([has-divider])) { --${za}-padding-block-end: 0; }
  }
...
`,ln=u`
  &:where([arc-popover*=top], [arc-popover*=bottom]) {
    --${h}-min-width: calc(var(--js-w) + ((var(--${v}-shift) - var(--${W}-size)) * 2));
    --${h}-min-height: auto;
  }
  ...
  &:where([arc-popover*=right]) {
    --${h}-tr: 0 var(--${v}-radius);
    --${h}-tx: calc(0% + var(--${Br}-x));
    --${v}-tx: -50%;

    &:where([arc-popover*=-start]) {
      --${h}-trail-mix: 62.5%;
      --${h}-ty: calc(0% - var(--${G}-y));
      --${v}-ty: calc(50% + var(--${G}-y));
...
`,dn=u`
  ...
  &[variant] {
    ...
    --${ta}-divider-color: var(--arc-color-border-standard);
    --${W}-color: var(--${h}-background);
    --${v}-background: var(--${W}-color);
    --${v}-outline-color: var(--${W}-color);
    --${v}-border: solid var(--${W}-size) var(--${v}-outline-color);
  ...
  &[variant=common][is-inverse] {
    ...
    --${ta}-divider-color: var(--arc-color-alpha-white-20);
  }
  ...
  [arc-popover] {
    ...
    */
    ...
    [arc-popover-content] {
      ...
      border: var(--arc-popover-border, var(--${E}-2) solid transparent);
    ...
    [arc-popover-dismiss] {
      ...
      margin:  var(--arc-popover-dismiss-margin, calc(-1 * var(--${E}-6)) 0);
    }
    ...
    [arc-popover-body] {
      ...
      padding: var(--arc-popover-body-padding,
        var(--${za}-padding-block-start, var(--${E}-12))
        var(--${E}-12)
        var(--${za}-padding-block-end, var(--${E}-12))
        var(--${E}-12)
      );
    }
    ...
    [arc-popover-footer] {
      ...
      gap: var(--arc-popover-footer-gap, var(--${ta}-gap));

      padding: var(--arc-popover-footer-padding, var(--${E}-12));

      background: var(--arc-popover-footer-background, none);
      color: var(--arc-popover-footer-color, inherit);

      &:where([has-divider]) {
        border-top: var(--arc-popover-footer-border-top, var(--${E}-1) solid var(--${ta}-divider-color));
      }
    }
...
`,Ca={SETUP:sn,POSITION:ln,VARIANTS:dn,ELEMENTS:pn},un=u`
@layer arc-components {
  [arc-popover] {
    ${Ca.SETUP}
    ${Ca.POSITION}
...
`,hn=(r,a)=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a??"toggle"]()},mt=(0,b.forwardRef)(({children:r,popover:a=or.popover,alternateAnchor:e,anchorProps:o,anchorAt:i,boundary:c,variant:s=or.variant,isInverse:d,hasTail:l,tailSize:p=or.tailSize,offset:g=or.offset,hidePopoverButton:m,headerSlot:f,showDismiss:y,dismissProps:z,footerSlot:C,showFooterDivider:L,tag:T="div",contentTag:w="div",onToggle:$,...j},B)=>{const H=(0,b.useRef)(null),Z=(0,b.useRef)(null);(0,b.useImperativeHandle)(B,()=>Z.current);const[nr,rr]=(0,b.useState)(!1),[Dr,mr]=(0,b.useState)(i||or.anchorAt),[oe,Fr]=(0,b.useState)({}),[_r,_a]=(0,b.useState)(0),[Ur,Ea]=(0,b.useState)(l?g??0:0),ca=(0,b.useMemo)(()=>d&&[...qa].includes(s),[s,d]),Yr=(0,b.useMemo)(()=>({popoverTarget:j.id,"aria-haspopup":!0,"aria-controls":j.id,"aria-expanded":nr}),[j.id,nr]),ne=(0,b.useMemo)(()=>({isInverse:ca,isOpen:nr,"aria-label":"Dismiss",...Yr,...z}),[z,ca,nr,Yr]),br=(0,b.useMemo)(()=>({ref:H,...Yr,...o}),[H,o,Yr]),gr=(0,b.useCallback)(()=>typeof e=="function"?e(br):typeof e=="string"?document.getElementById(e):H.current,[e,br]),Er=(0,b.useCallback)(({...K})=>{mr(K.anchorAt),Fr(K.vars)},[mr,Fr]);return(0,b.useEffect)(()=>{const K=l?p??0:0,ar=Number(g??0)+K*(Math.sqrt(2)/2);_a(K),Ea(ar)},[l,p,g]),(0,b.useEffect)(()=>{const K=Z?.current,ar=gr();if(!ar)return;let xr=null,Tr=null,jr=null;const Ta=()=>{xr=ar?.getBoundingClientRect()??{},jr&&ve({a:xr,b:Tr})?(Tr=xr,Er(Wa({anchorElement:ar,popoverElement:K,anchorAt:i,boundary:c,offset:Ur,tailSize:_r}))):jr=null,jr=requestAnimationFrame(Ta)};jr=requestAnimationFrame(Ta)},[gr,nr,i,c,Ur,_r,Er]),(0,b.useEffect)(()=>{const K=Z.current;if(!K)return;const ar=xr=>{const{newState:Tr}=xr;rr(Tr==="open"),Er(Wa({anchorElement:gr(),popoverElement:K,anchorAt:i,boundary:c,offset:Ur,tailSize:_r})),$?.(xr)};return K.addEventListener("toggle",ar),()=>{K.removeEventListener("toggle",ar)}},[Z,$,gr,i,c,Ur,_r,Er]),(0,n.jsxs)(n.Fragment,{children:[!(e&&m)&&(0,n.jsx)(ea,{...br}),(0,n.jsxs)(T,{...j,role:j.role??"dialog","arc-popover":Dr,ref:Z,popover:a,boundary:c,variant:s,"is-inverse":ca?"":void 0,"has-tail":l?"":void 0,style:{...j.style,...oe},children:[l&&(0,n.jsx)(cn,{}),(0,n.jsxs)(w,{"arc-popover-content":"",children:[!!f&&(0,n.jsx)(tn,{showDismiss:y,dismissProps:ne,children:f}),f||C?(0,n.jsx)(on,{children:r}):r,!!C&&(0,n.jsx)(nn,{showDivider:L,children:C})]}),y&&!f&&(0,n.jsx)(ht,{...ne})]})]})});mt.displayName="ArcPopover";const ae=mt;ae.handlePopover=hn,ae.Button=ea;const oa=ae;S("ArcPopover",un);const vn=u`
@layer arc-components {
...
`,mn=r=>(0,n.jsx)("ul",{...r,"data-element":"list"}),gn=r=>(0,n.jsx)("li",{...r,"data-element":"list-item"}),fn=({count:r,anchorId:a,overflowId:e,shouldShowOverflow:o,...i})=>(0,n.jsx)(Za,{title:`+${r}`,children:(0,n.jsx)(oa.Button,{...i,id:a,popoverTarget:e,text:`+${r}`,variant:"common",hierarchy:"primary",disabled:!o,"data-element":"counter","data-color":"black","data-num-length":r?.toString().length})}),bn=({children:r,id:a,size:e="sm",overflowCount:o=0,shouldShowOverflow:i=!1,anchorAt:c="bottom-end",boundary:s="flip",...d})=>{const l=Math.min(o,999),p=(0,b.useMemo)(()=>ga(a,"arc-avatar-overflow"),[a]),g=(0,b.useMemo)(()=>`${p}-anchor`,[p]),m=(0,b.useMemo)(()=>b.Children.toArray(r),[r]);return(0,n.jsxs)(n.Fragment,{children:[l>0&&(0,n.jsx)(fn,{count:l,anchorId:g,overflowId:p,shouldShowOverflow:i}),i&&l>0&&(0,n.jsx)(oa,{...d,"arc-avatar-overflow":"",id:p,anchorAt:c,boundary:s,alternateAnchor:g,hidePopoverButton:!0,variant:"common",isInverse:!0,"data-size":e,children:(0,n.jsx)(mn,{children:m.map((f,y)=>(0,n.jsx)(gn,{children:f},y))})})]})};S("ArcAvatarOverflow",vn);const xn=u`
@layer arc-components {
...
`,$n=A(er,["inherit","lg","md","sm"]),yn=A(sr,["hug","fill"]),wn=["high","low"],An=A(q,["brand-black","brand-blue","neutral","info","success","warning","critical","ai","overlay-light","overlay-dark"]),kn=({children:r,icon:a,text:e,isFlipped:o,isFlexible:i,isUppercase:c,variant:s="brand-blue",size:d="inherit",layout:l="hug",contrast:p="high",...g})=>{const m=r||(0,n.jsx)(cr,{icon:a,text:e,isFlipped:o,layout:"gutter"}),f=l==="fill"&&i;return(0,n.jsx)("span",{...g,"arc-badge-wrapper":"",children:(0,n.jsx)("span",{"arc-badge":"","data-contrast":p,"data-variant":s,"data-layout":l,"data-size":d,"data-is-flexible":f?"":void 0,"data-is-uppercase":c?"":void 0,children:m})})};S("ArcBadge",xn);const zn=u`
@layer arc-components {
...
`,Cn=A(er,["inherit","lg","md","sm"]),Sn=A(q,["neutral","brand","critical","warning","success","inverse"]),_n=A(ja,["square","circle"]),En=({children:r,text:a,variant:e="neutral",size:o="inherit",shape:i="square",...c})=>{const s=r||a;return(0,n.jsx)("span",{...c,"arc-badge-count-wrapper":"",children:(0,n.jsx)("span",{"arc-badge-count":"","data-variant":e,"data-shape":i,"data-size":o,children:s})})};S("ArcBadgeCount",zn);const Tn=u`
@layer arc-components {
...
`,jn=A(sr,["hug","fill"]),Cr=({layout:r,...a})=>(0,n.jsx)("label",{...a,"arc-label":"","data-layout":r});S("ArcLabel",Tn);const In=u`
@layer arc-components {
...
`,Sr=r=>(0,n.jsx)("span",{...r,"arc-label-content":""});S("LabelContent",In);const Pn={checkbox:"checkbox",radio:"radio",switch:"radio"},na=({id:r,indeterminate:a,type:e,onChange:o,...i})=>{const c=e==="checkbox"&&!!a,s=(0,b.useRef)(null),d=(0,b.useMemo)(()=>r||dr(`arc-${e}`),[r,e]),l=p=>g=>{if(!(g?.target instanceof HTMLInputElement))return;const m={checked:g?.target.checked,indeterminate:g?.target?.indeterminate,name:g?.target?.name,value:i?.value};p?.(m,g)};return(0,b.useEffect)(()=>{s.current?.type==="checkbox"&&(s.current.indeterminate=!!a)},[a]),(0,n.jsx)("input",{...i,id:d,ref:s,type:Pn[e],"arc-input-type":e,"aria-disabled":i?.disabled||void 0,"data-is-disabled":i?.disabled||void 0,"data-is-checked":i?.checked||void 0,"data-is-indeterminate":c||void 0,onChange:l(o)})},Ln=u`
@layer arc-components {
...
`,Sa=({type:r,...a})=>(0,n.jsx)("span",{"arc-input-mask-wrapper":"",children:(0,n.jsx)("span",{...a,"arc-input-mask":r})});S("ArcBooleanInputMask",Ln);const Rn=u`
@layer arc-components {
...
`,Mn=A(sr,["hug","fill"]),On=A(er,["inherit","md","sm"]),Bn=A(q,["primary","secondary"]),gt=({children:r,label:a,layout:e,size:o="md",variant:i="primary",useMask:c=!0,...s})=>{const{className:d,title:l,...p}=s,g={className:d,title:l},m=r??a,f=(0,n.jsx)(na,{...p,type:"checkbox"}),y=c&&(0,n.jsxs)(Sa,{type:"checkbox",children:[f,(0,n.jsx)(I,{icon:p?.indeterminate?"fa-solid fa-minus fa-fw":"fa-solid fa-check fa-fw"})]}),z=!!m&&(0,n.jsxs)(Cr,{layout:e,children:[y||f,(0,n.jsx)(Sr,{children:m})]});return(0,n.jsx)("span",{...g,"arc-checkbox":"","data-size":o,"data-variant":i,children:z||y||f})};S("ArcCheckbox",Rn);const Hn=u`
@layer arc-components {
...
`,Nn=A(sr,["hug","fill"]),Vn=A(er,["lg","md"]),Dn=({children:r,label:a,icon:e,...o})=>{const i=r||(0,n.jsx)(cr,{icon:e,text:a});return(0,n.jsx)("li",{"arc-checkbox-bar-option":"","data-is-checked":o?.checked||void 0,children:(0,n.jsx)(gt,{...o,label:i,layout:"fill",useMask:!1})})},Fn=({children:r,size:a="lg",layout:e="hug",...o})=>(0,n.jsx)("ul",{...o,"arc-checkbox-bar":"","data-size":a,"data-layout":e,role:"group",children:r});S("ArcCheckboxBar",Hn);const Un=r=>[{rule:()=>r.icon&&typeof r.subtext<"u",value:"icon-text-detail"},{rule:()=>r.icon,value:"icon-text"},{rule:()=>r.avatar&&typeof r.subtext<"u",value:"user-detail"},{rule:()=>r.avatar,value:"user"},{rule:()=>typeof r.subtext<"u",value:"text-detail"},{rule:()=>!0,value:"text"}],Yn=({icon:r,iconSize:a,layout:e,...o})=>{const i={overflow:"truncate",gapSize:"md",size:"md"},c=r&&typeof r=="string"?`${r.replace(" fa-fw","")} fa-fw`:r;return{"icon-text":(0,n.jsx)(cr,{...o,...i,iconSize:a,layout:e,variant:"inherit",icon:c}),"icon-text-detail":(0,n.jsx)(cr,{...o,...i,iconSize:a,layout:e,isStrong:!0,variant:"inherit",icon:c}),text:(0,n.jsx)(cr,{...o,...i,layout:e,variant:"inherit"}),"text-detail":(0,n.jsx)(cr,{...o,...i,layout:e,isStrong:!0,variant:"inherit"}),user:(0,n.jsx)(Xa,{...o,...i,size:"sm"}),"user-detail":(0,n.jsx)(Xa,{...o,...i,size:"md",isStrong:!0})}},Zn=r=>{const a=r?.variant??Un(r).find(e=>e.rule())?.value;return{itemType:a,ItemTemplate:e=>Yn(e)[a]}},ft=({itemId:r,startSlot:a,endSlot:e,onClick:o,...i})=>{const{itemType:c,ItemTemplate:s}=Zn(i),d=a?"":void 0,l=e?"":void 0,p=()=>(0,n.jsxs)(n.Fragment,{children:[a," ",(0,n.jsx)(s,{...i,"is-item-content":""})," ",e]}),g=m=>{const f=m.currentTarget.closest("[arc-popover]");o?.(m.nativeEvent),f?.hidePopover()};return o?(0,n.jsx)(zr,{_isCustom:!0,"arc-dropdown-item":c??"","has-start-slot":d,"has-end-slot":l,onClick:g,children:(0,n.jsx)(p,{})}):(0,n.jsx)("div",{"arc-dropdown-item":c??"","has-start-slot":d,"has-end-slot":l,children:(0,n.jsx)(p,{})})},Xn=u`arc•dropdown`,qn=u`${Xn}•menu`,F=u`${qn}•item`,Wn=u`
@layer arc-components {

  /* ITEM SETUP ----------------------------------------------------• */

  [arc-dropdown-item] {
    --${F}-base-padding: max(8px, 0.5em) max(12px, 0.75em);
    --${F}-padding: var(--${F}-base-padding);
    --${F}-min-height: max(36px, 2.25em);
    --${F}-gap: max(8px, 0.5em);

    &[arc-dropdown-item=text-detail] {
      --${F}-min-height: max(48px, 3em);
    }

    &[arc-dropdown-item=user] {
      --${F}-min-height: max(40px, 2.5em);

      &:not([has-start-slot]) {
        --${F}-padding: var(--${F}-base-padding) max(8px, 0.5em) max(10px, 0.625em);
      }
    }
    ...
    &[arc-dropdown-item=user-detail] {
      ...
      &:not([has-start-slot]) {
        --${F}-padding: var(--${F}-base-padding) max(8px, 0.5em) max(6px, 0.375em);
      }
    }
  }
  ...
  [arc-dropdown-item] {
    ...
    min-height: var(--${F}-min-height);
    max-width: 100%;

    &:is([arc-button]) {
      --arc-button-padding: var(--${F}-padding);
    }
...
`,Kn=u`arc•menu`,Hr=u`${Kn}•item`,Gn=u`
@layer arc-components {

  [arc-menu] {
    --${Hr}-gap: max(8px, 0.5em);
    --${Hr}-background: inherit;
  ...
  [arc-menu-item] {
    ...
    background: var(--arc-menu-item-background, var(--${Hr}-background));
    ...
    &:has(> [arc-button=custom]:not(:disabled)):hover {
      --${Hr}-background: color-mix(in srgb, currentcolor 7%, transparent);
    }
...
`,Jn=({items:r,filterText:a,renderItem:e,isVisible:o,...i})=>{const c=(0,b.useRef)(null),[s,d]=(0,b.useState)(-1),[l,p]=(0,b.useState)(!1),g=a?r.filter(w=>Object.values(w).some($=>$===a)):r,m=Math.max(g.length-1,0),f=(0,b.useCallback)(w=>c.current?.children[w]?.querySelector("[arc-button=custom]"),[]),y=(0,b.useCallback)((w,$,j)=>{let B=1,H=w;const Z=rr=>rr>=j?0:rr+1,nr=rr=>rr<=0?j:rr-1;for(;B<=j;){const rr=Z(H),Dr=nr(H),mr={previous:$==="previous"?Dr:H,actual:H,next:$==="next"?rr:H}[$];if(f(mr))return mr;H=mr,B+=1}return-1},[f]),z=(0,b.useCallback)((w,$)=>{const j=y(w,$,m);d(j),f(j)?.focus()},[y,m,f]),C={ArrowUp:w=>z(w,"previous"),ArrowDown:w=>z(w,"next"),Home:()=>z(0,"actual"),End:()=>z(m,"actual")},L=w=>$=>{Object.keys(C).includes($.key)&&(p(!0),$.stopPropagation(),$.preventDefault(),C[$.key](w))},T=(w,$)=>()=>{!l&&$&&z(w,"actual")};return(0,b.useEffect)(()=>{o&&z(-1,"next")},[o,z]),(0,n.jsx)("ul",{...i,ref:c,"arc-menu":"",role:"menu",onKeyDown:L(s),onMouseLeave:()=>d(-1),onMouseMove:()=>p(!1),tabIndex:o?0:-1,children:g.map((w,$)=>(0,n.jsx)("li",{"arc-menu-item":w?.variant??"",role:"menuitem",onMouseEnter:T($,!!w.onClick),id:w.itemId,children:e?.(w,$,{filterText:a,isCurrent:$===s})},w.itemId))})};S("ArcMenu",Gn);const bt=(0,b.forwardRef)((r,a)=>(0,n.jsx)(ea,{...r,ref:a,"arc-dropdown-menu-button":""})),ee=r=>{const{items:a,renderItem:e,...o}=r,[i,c]=(0,b.useState)(!1),s=(0,b.useCallback)((...l)=>e?.(...l)||(0,n.jsx)(ft,{...l[0]}),[e]),d=l=>c(l.newState==="open");return(0,n.jsx)(oa,{...o,"arc-dropdown":"",variant:"common",onToggle:d,children:(0,n.jsx)(Jn,{"arc-dropdown-menu":"",items:a??[],renderItem:s,isVisible:i})})};bt.displayName="ArcDropdownButton",ee.Button=bt,ee.Item=ft,S("ArcDropdownMenu",Wn);const Qn=r=>(0,n.jsx)(zr,{...r,layout:"icon",size:"md",variant:"common",hierarchy:"tertiary"}),J=u`arc•link`,U=u`${J}•icon`,Y=u`${J}•text`,ri=u`
@layer arc-components {
...
[arc-link] {
  ...
  &[data-variant=inherit] { /* @default */
    ...
    --${Y}-color-hover: color-mix(in srgb, currentcolor, transparent 38.75%);
    --${Y}-color-disabled: color-mix(in srgb, currentcolor, transparent 70%);

    --${J}-focus-color: var(--arc-color-border-focus);
  }

  &[data-variant=primary] {
    --${U}-color: var(--arc-color-icon-primary);
    --${Y}-color: var(--arc-color-text-primary);
    --${U}-color-hover: var(--arc-color-icon-primary-hover);
    --${Y}-color-hover: var(--arc-color-text-primary-hover);
    --${U}-color-disabled: var(--arc-color-icon-disabled);
    --${Y}-color-disabled: var(--arc-color-text-disabled);
    --${J}-focus-color: var(--arc-color-border-focus);
  }

  &[data-variant=secondary] {
    --${U}-color: var(--arc-color-icon-secondary);
    --${Y}-color: var(--arc-color-text-secondary);
    --${U}-color-hover: var(--arc-color-icon-secondary-hover);
    --${Y}-color-hover: var(--arc-color-text-secondary-hover);
    --${U}-color-disabled: var(--arc-color-icon-disabled);
    --${Y}-color-disabled: var(--arc-color-text-disabled);
    --${J}-focus-color: var(--arc-color-border-focus);
  }
  ...
  &[data-variant=inverse] {
    --${U}-color: var(--arc-color-icon-inverse);
    --${Y}-color: var(--arc-color-text-inverse);
    --${U}-color-hover: var(--arc-color-icon-inverse-hover);
    --${Y}-color-hover: var(--arc-color-text-inverse-hover);
    --${U}-color-disabled: var(--arc-color-icon-inverse-disabled);
    --${Y}-color-disabled: var(--arc-color-text-inverse-disabled);
  ...
  &:not([data-is-disabled]):hover {
    --${Y}-color: var(--arc-link-color-hover, var(--${Y}-color-hover));
  ...
  &[data-is-disabled] {
    --${Y}-color: var(--arc-link-color-disabled, var(--${Y}-color-disabled));
  ...
  & {
    ...
    /* Inter-Component Communication -------------------------------• */
    --arc-icon-color: var(--arc-link-color, var(--${U}-color));  /** ArcIcon color */
...
[arc-link] {
  color: var(--arc-link-color, var(--${Y}-color));
...
`,ai=A(q,["inherit","primary","secondary","inverse"]),ei=({children:r,layout:a="gutter",size:e="inherit",variant:o="inherit",tag:i="a",href:c,icon:s,text:d,overflow:l,iconSize:p,gapSize:g,isFlipped:m,isDisabled:f,...y})=>(0,n.jsx)(i,{...y,href:f?void 0:c,"arc-link":"","data-variant":o,"aria-disabled":f,"data-is-disabled":f?"":void 0,children:r||(0,n.jsx)(cr,{icon:s,text:d,overflow:l,iconSize:p,gapSize:g,size:e,layout:a,isFlipped:m})});S("ArcLink",ri);const ti=u`
@layer arc-components {
...
`,oi=A(sr,["hug","fill"]),ni=A(er,["inherit","md","sm"]),xt=({children:r,label:a,layout:e,size:o="md",useMask:i=!0,...c})=>{const{className:s,title:d,...l}=c,p={className:s,title:d},g=r??a,m=(0,n.jsx)(na,{...l,type:"radio"}),f=i&&(0,n.jsxs)(Sa,{type:"radio",children:[m,(0,n.jsx)(I,{icon:"fa-solid fa-circle-small fa-fw"})]}),y=!!g&&(0,n.jsxs)(Cr,{layout:e,children:[f||m,(0,n.jsx)(Sr,{children:g})]});return(0,n.jsx)("span",{...p,"arc-radio":"","data-size":o,children:y||f||m})};S("ArcRadio",ti);const ii=u`
@layer arc-components {
...
`,ci=A(sr,["hug","fill"]),si=A(er,["lg","md"]),li=({children:r,label:a,icon:e,...o})=>{const i=r||(0,n.jsx)(cr,{icon:e,text:a});return(0,n.jsx)("li",{"arc-radio-bar-option":"","data-is-checked":o?.checked||void 0,children:(0,n.jsx)(xt,{...o,label:i,layout:"fill",useMask:!1})})},di=({children:r,size:a="lg",layout:e="hug",...o})=>(0,n.jsx)("ul",{...o,"arc-radio-bar":"","data-size":a,"data-layout":e,role:"radiogroup",children:r});S("ArcRadioBar",ii);const pi=A(er,["inherit","md","sm"]),V={On:"on",Off:"off"},Nr={Before:"before",After:"after"},ui=({disabled:r,id:a,name:e,size:o="md",value:i,labelOff:c,labelOn:s,onChange:d,...l})=>{const p=(0,b.useMemo)(()=>e||dr("arc-switch-name"),[e]),g=(0,b.useMemo)(()=>a&&`${a}-off`||dr("arc-switch-off"),[a]),m=(0,b.useMemo)(()=>a&&`${a}-on`||dr("arc-switch-on"),[a]),f=w=>{if(w.code==="Space"){w.preventDefault(),w.stopPropagation();const $=i===V.On?V.Off:V.On;d?.({value:$},w)}},y=w=>{const $={on:Qr(s),off:Qr(c)};return $?.on&&$?.off?$[w]:!$?.on&&$?.off?`${$?.off}: ${w}`:$?.on&&!$?.off?`${$?.on}: ${w}`:$[w]},z=(0,n.jsxs)(Sa,{type:"switch",onKeyDown:f,children:[(0,n.jsx)(na,{type:"switch",name:p,id:g,value:V.Off,checked:i===V.Off,disabled:r,"aria-label":y(V.Off)?.trim(),onChange:d}),(0,n.jsx)(na,{type:"switch",name:p,id:m,value:V.On,checked:i===V.On,disabled:r,"aria-label":y(V.On)?.trim(),onChange:d}),(0,n.jsx)("span",{"data-element":"mask"})]}),C=!s&&i===V.Off?m:g,L=!c&&i===V.On?g:m,T=!!(s||c)&&(0,n.jsxs)(n.Fragment,{children:[!!c&&(0,n.jsx)(Cr,{htmlFor:C,"arc-switch-label":s?V.Off:"",children:(0,n.jsx)(Sr,{children:c})}),z,!!s&&(0,n.jsx)(Cr,{htmlFor:L,"arc-switch-label":c?V.On:"",children:(0,n.jsx)(Sr,{children:s})})]});return(0,n.jsx)("span",{...l,"arc-switch":"","data-state":i,"data-size":o,role:"radiogroup",children:T||z})},hi=u`
@layer arc-components {
...
`,vi=({disabled:r,id:a,name:e,size:o="md",value:i,label:c,labelPosition:s=Nr.After,onChange:d,labelOff:l,labelOn:p,...g})=>{const m=(0,b.useMemo)(()=>e||dr("arc-switch-name"),[e]),f=(0,b.useMemo)(()=>a||dr("arc-switch"),[a]),y=(L,T)=>{const w=L.checked?V.On:V.Off;d?.({...L,value:w},T)};!c&&(p||l)&&(c=p||l,s=p?Nr.After:Nr.Before);const z=(0,n.jsxs)(Sa,{type:"checkbox",children:[(0,n.jsx)(na,{type:"checkbox",name:m,id:f,checked:i===V.On,disabled:r,role:"switch","aria-checked":i===V.On,"aria-label":c?void 0:"Toggle switch",tabIndex:0,onChange:y}),(0,n.jsx)("span",{"data-element":"mask","aria-hidden":"true",tabIndex:-1})]}),C=(0,n.jsx)(Cr,{htmlFor:f,"arc-switch-label":s,children:(0,n.jsx)(Sr,{children:c})});return l&&p?(0,n.jsx)(ui,{...g,disabled:r,id:a,name:e,labelOff:l,labelOn:p,size:o,value:i,onChange:d}):(0,n.jsxs)("span",{...g,"arc-switch":"","data-state":i,"data-size":o,"data-label-position":s,role:"presentation","aria-live":"off",children:[c&&s===Nr.Before&&C,z,c&&s===Nr.After&&C]})};S("ArcSwitch",hi);const mi=["title","heading","subheading","body"],$t=["h1","h2","h3","h4","h5","h6"],yt=["code","div","li","p","pre","span"],wt=[...$t,...yt],gi=["title-inherit","title-lg","title-md","title-sm"],fi=["heading-inherit","heading-lg","heading-md","heading-sm"],bi=["subheading-inherit","subheading-lg","subheading-md","subheading-sm"],xi=A(q,["inherit","primary","primary-inverse"]),$i=["body-inherit","body-lg","body-md","body-sm","body-xs"],yi=A(q,["inherit","primary","secondary","primary-inverse","secondary-inverse","critical","warning","success","info"]),wi=A(se,["inherit","start","center","justify","end"]),Ai=A(le,["inherit","loose","standard","tight"]),ki={h1:"title",h2:"heading",h3:"heading",h4:"subheading",h5:"subheading",h6:"subheading",p:"body",span:"body",div:"body",code:"body",pre:"body",li:"body"},zi=r=>{const{align:a,lineHeight:e,size:o,variant:i,isMonospace:c,tag:s,...d}=r,l=ki?.[s]??"body",p=o?.includes("inherit")?o?.split("-")?.[0]:o;return{...d,"arc-text":p||l,"data-is-monospace":c?"":void 0,"data-align":a?.includes("inherit")?void 0:a,"data-variant":i?.includes("inherit")?void 0:i,"data-line-height":e?.includes("inherit")?void 0:e}},Ci=u`
@layer arc-components {
...
`,Si=r=>(0,b.forwardRef)((a,e)=>(0,b.createElement)(r,{...zi({...a,tag:r}),ref:e})),_i=[...wt].reduce((r,a)=>({...r,[a]:Si(a)}),{});S("Arc",Ci);const Vr=r=>(0,n.jsx)(n.Fragment,{children:!!r.children&&(0,n.jsx)("span",{...r})}),Ei=r=>(0,n.jsx)(n.Fragment,{children:!!r.children&&(0,n.jsx)("span",{...r})}),te=({children:r,...a})=>(0,n.jsx)(n.Fragment,{children:!!r&&(0,n.jsx)(Cr,{...a,children:(0,n.jsx)(Sr,{children:r})})}),Ti=({children:r,layout:a,size:e,variant:o,tag:i="span",...c})=>(0,n.jsx)(i,{...c,"data-layout":a,"data-size":e,"data-variant":o,children:r}),ji=()=>(0,n.jsx)("span",{"input-element":"spacer"}),Ii=r=>(0,n.jsx)(Vr,{...r,"input-element":"header"}),Pi=r=>(0,n.jsx)(te,{...r,"input-element":"header-label"}),Li=r=>(0,n.jsx)(Vr,{...r,"input-element":"header-slot"}),Ri=r=>(0,n.jsx)(Vr,{...r,"input-element":"body"}),Mi=r=>(0,n.jsx)(te,{...r,"input-element":"input-prefix"}),Oi=r=>(0,n.jsx)(te,{...r,"input-element":"input-suffix"}),Bi=r=>(0,n.jsx)(Ei,{...r,"input-element":"input-action"}),Hi=r=>(0,n.jsx)(Vr,{...r,"input-element":"footer"}),Ni=r=>(0,n.jsx)(Vr,{...r,"input-element":"footer-caption"}),Vi=r=>(0,n.jsx)(Vr,{...r,"input-element":"footer-slot"}),Di=r=>a=>{if(!(a?.target instanceof HTMLInputElement))return;const e={name:a?.target?.name,value:a?.target?.value};r?.(e,a)},Fi=u`
@layer arc-components {
...
`,Ui={onChangeHandler:Di,Wrapper:Ti,Spacer:ji,Header:Ii,HeaderLabel:Pi,HeaderSlot:Li,InputBody:Ri,InputPrefix:Mi,InputSuffix:Oi,InputAction:Bi,Footer:Hi,FooterCaption:Ni,FooterSlot:Vi};S("ArcInput",Fi);const Q=Ui,Yi=A(sr,["fill","hug"]),Zi=A(er,["inherit","xl","lg","md"]),Xi=A(q,["outline","solid"]),qi=Yi,Wi=Zi,Ki=Xi,Gi=["text","number","password","email","url"],Ji=(0,b.forwardRef)(({layout:r="hug",size:a="inherit",variant:e="outline",inputProps:o,headerLabel:i,headerSlot:c,inputPrefix:s,inputAction:d,inputSuffix:l,footerCaption:p,footerSlot:g,...m},f)=>{const{id:y,onChange:z,...C}=o,L=C?.type||"text",T=C?.disabled||void 0,w=C?.readOnly||void 0,$=C?.required||void 0,j=!!(i||c),B=!!(p||g);return(0,n.jsxs)(Q.Wrapper,{...m,"arc-text-input":"","arc-input":L,layout:r,size:a,variant:e,children:[j&&(0,n.jsxs)(Q.Header,{children:[(0,n.jsx)(Q.HeaderLabel,{htmlFor:y,children:i}),!!c&&(0,n.jsx)(Q.Spacer,{}),(0,n.jsx)(Q.HeaderSlot,{children:c})]}),(0,n.jsxs)(Q.InputBody,{children:[(0,n.jsx)(Q.InputPrefix,{htmlFor:y,children:s}),(0,n.jsx)("input",{...C,ref:f,id:y,"arc-input-type":L,onChange:Q.onChangeHandler(z),"aria-disabled":T,"aria-readonly":w,"aria-required":$}),(0,n.jsx)(Q.InputSuffix,{htmlFor:y,children:l}),(0,n.jsx)(Q.InputAction,{children:d})]}),B&&(0,n.jsxs)(Q.Footer,{children:[(0,n.jsx)(Q.FooterCaption,{children:p}),!!g&&(0,n.jsx)(Q.Spacer,{}),(0,n.jsx)(Q.FooterSlot,{children:g})]})]})}),At=u`arc•progress`,kt=u`${At}•bar`,ia=u`${At}•value`,Qi=u`
@layer arc-components {
[arc-progress-bar] {
  --${kt}-background: var(--arc-color-alpha-white-20);
  --${ia}-background: var(--arc-color-brand-root);

  &[data-variant=ai] {
    --${ia}-background: linear-gradient(to right, var(--arc-color-ai-purple-200), var(--arc-color-ai-blue-200));
  }

  &[data-variant=critical] {
    --${ia}-background: var(--arc-color-critical-root);
  }
}
...
[arc-progress-bar] {
  ...
  background: var(--arc-progress-bar-background, var(--${kt}-background));
  ...
  &::-moz-progress-bar {
    border-radius: var(--arc-border-radius-pill);
    background: var(--arc-progress-bar-value-background, var(--${ia}-background));
  }
...
`,rc=({progress:r=0,variant:a="common",...e})=>(0,n.jsxs)("progress",{...e,"arc-progress-bar":"","data-variant":a,value:r,max:e.max||100,"aria-valuenow":r,"aria-valuemax":e.max||100,children:[r,"% "]});S("ArcProgressBar",Qi);const ac=u`
@layer arc-components {
...
`,ec=A(q,["common","ai","critical"]),tc=["default","success","warning","error"],oc=A(er,["inherit","md"]),nc=A(q,["common"]),ic=[...Pa],cc=[...la],sc=["top-left","top-center","top-right","center","bottom-left","bottom-center","bottom-right"],lc=ec.filter(r=>r!=="critical"),dc=(r,a="toggle")=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a]()},zt=({id:r,children:a,icon:e,heading:o,subtext:i,dismissProps:c,showDismiss:s=!0,onClose:d,actionSlot:l,size:p="md",variant:g="common",placement:m="bottom-left",getToastId:f,progressBarProps:y,severity:z,...C})=>{const L=()=>{d?.()},T=!!l||s,w=(0,b.useMemo)(()=>r||dr("arc-toast"),[r]),{variant:$,hierarchy:j,...B}=c||{};return(0,b.useEffect)(()=>{f?.(w)},[f,w]),(0,n.jsx)("div",{...C,"arc-toast":"","data-size":p,"data-variant":g,"data-placement":m,"data-severity":z||void 0,id:w,children:(0,n.jsxs)("div",{"arc-toast-content-grid":"",children:[(0,n.jsxs)("div",{"arc-toast-body":"",children:[e&&(0,n.jsx)(I,{icon:e,"arc-toast-icon":""}),(0,n.jsx)("div",{"arc-toast-content":"",children:a||(0,n.jsxs)(n.Fragment,{children:[o&&(0,n.jsx)("header",{"arc-toast-heading":"",children:(0,n.jsx)("strong",{children:o})}),i&&(0,n.jsx)("p",{"arc-toast-subtext":"",children:i})]})})]}),T&&(0,n.jsxs)("div",{"arc-toast-actions":"",children:[l,s&&(0,n.jsx)(zr,{icon:"fa-regular fa-xmark-large",layout:"icon",variant:"common",hierarchy:"tertiary",isInverse:!0,size:"md",shape:"square","aria-label":"Dismiss",...B,popoverTarget:w,onClick:L})]}),y&&(0,n.jsx)(rc,{...y,variant:z==="error"?"critical":y.variant,"arc-toast-progress-bar":""})]})})};zt.handleToast=dc,S("ArcToast",ac)}}]);
